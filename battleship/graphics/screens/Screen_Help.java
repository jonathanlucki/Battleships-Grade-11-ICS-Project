...
import battleship.graphics.elements.misc.Help;
 ...
 * <p>
 * Class Description:  This class constructs the help screen from screen elements
 * @author Jonathan Lucki
 * @version Last modified on 15/06/2016
 */ 


public class Screen_Help extends Screen {
  
  //credits screen constructor
  public Screen_Help() {
    elements = new Element[]{new Help()};
  }
