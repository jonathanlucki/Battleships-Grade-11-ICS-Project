 ...
 * <p>
 * Class Description: This class is a screen element which creates the defeat screen
 * @author Jonathan Lucki
 * @version Last modified on 15/06/2016
 */ 


public class Defeat implements Element {
  ...
  public void draw (Graphics g, int width, int height) {
    ...
    if (width < (height * 1.47)) {
      g.drawImage(Resources.menuDefeat, ((width / 2) - ((int)(height * 1.47) / 2)), 0, (int)(height * 1.47), height, null);
    } else {
      g.drawImage(Resources.menuDefeat, 0, 0, width, (height), null);
    }
    
    g.drawImage(Resources.menuDefeatText, width / 2 - 300,  50, 600, 200, null);
